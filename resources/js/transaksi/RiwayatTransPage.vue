            ...
            <!-- <div class="modal fade" id="exampleModal1" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" v-if="historyDel.deleted_at == null">
                            Apakah Anda Yakin Untuk Menghapus data Transaksi dengan Kode "{{historyDel.kode}}" ?
                        </div>
                        <div class="modal-body" v-if="historyDel.deleted_at != null">
                            Apakah Anda Yakin Untuk Mengembalikan data Transaksi dengan Kode "{{historyDel.kode}}" ?
                        </div>
                        <form @submit.prevent="deleteBarang()" method="post" class="d-grid">
                            <input type="hidden" class="form-control lbl-text" id="kodePegawaiDelete" v-model="historyDel.kode">
                            <div class="modal-footer">
